...
class Client(Iface):
  ...
  def addDoc(self, meta):
    ...
    Parameters:
     - meta
    """
    self.send_addDoc(meta)
    return self.recv_addDoc()

  def send_addDoc(self, meta):
  ...
  def recv_addDoc(self, ):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "addDoc failed: unknown result");
...
class Processor(Iface, TProcessor):
  ...
  def process_addDoc(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = addDoc_result()
    result.success = self._handler.addDoc(args.meta)
...
class search_result:
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(MetaBean, MetaBean.thrift_spec)), None, ), # 0
  )
...
class addDoc_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'meta', (MetaBean, MetaBean.thrift_spec), None, ), # 1
  )
